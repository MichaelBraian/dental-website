...
interface HomeStaffSectionProps {
  doctors: StaffMember[]
  staff: StaffMember[]
  values: Value[]
  locale: string
...
export function HomeStaffSection({ doctors, staff, values, locale, titles }: HomeStaffSectionProps) {
  ...
  return (
    <>
      ...
      <AnimatedSection animation="fadeIn" className="bg-gray-900 py-16">
